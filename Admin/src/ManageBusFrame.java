...
public class ManageBusFrame extends JFrame{
    ...
    private void showSeatMap(int soGhe, String idXe) {
        ...
        if (soGhe == 16) { cl.show(panelGhe, "card16"); activePanel = panel16; }
        else if (soGhe == 30) { cl.show(panelGhe, "card30"); activePanel = panel30; }
    ...
    private void resetToDefault() { clearFields(); disableFields(); currentAction = ""; }
    private void clearFields() {
        txtIDxe.setText(""); txtBienSo.setText(""); txtSoGhe.setText("");
        txtID.setText(""); txtTenLoaiXe.setText(""); cboLoaiXe.setSelectedIndex(-1);
        showSeatMap(0, "");
    }
    private void disableFields() {
        txtIDxe.setEditable(false); txtBienSo.setEditable(false); txtSoGhe.setEditable(false);
        txtTenLoaiXe.setEditable(false); cboLoaiXe.setEnabled(false);
    ...
    private void enableFieldsForEditing() {
        txtBienSo.setEditable(true); txtTenLoaiXe.setEditable(true);
        txtBienSo.setBackground(Color.WHITE); txtTenLoaiXe.setBackground(Color.WHITE);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new ManageBusFrame().setVisible(true));
    }
}
